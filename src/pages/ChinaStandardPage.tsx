      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="space-y-8 mb-20">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-2xl font-bold">能力进阶图解</h3>
          </div>
          ...
          <div className="relative border-l-2 border-gray-200 ml-4 md:ml-6 space-y-12 pb-4">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <span className="px-3 py-1 bg-green-50 text-green-700 text-sm font-bold rounded-lg">预备级</span>
                    <h4 className="text-xl font-bold">感知与积累</h4>
                  </div>
                  <span className="text-sm text-[#86868b] mt-2 md:mt-0">适用阶段：学前 / 低年级</span>
                </div>
            ...
            <div className="relative pl-8 md:pl-12 group">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                 <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <span className="px-3 py-1 bg-blue-50 text-blue-700 text-sm font-bold rounded-lg">一级</span>
                    <h4 className="text-xl font-bold">基础构建</h4>
                  </div>
                  <span className="text-sm text-[#86868b] mt-2 md:mt-0">适用阶段：1-3 年级</span>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2 text-[#86868b]">
                        <div className="flex items-center text-[#1d1d1f] font-medium mb-2">
                            <Target className="w-4 h-4 mr-2" /> 核心目标
                        </div>
                        <p>识别拼读规则，理解简单句。</p>
                    ...
                    <div className="bg-blue-50/50 rounded-xl p-4 text-center">
                        ...
                        <div className="text-xs text-blue-800/60 font-medium uppercase tracking-wider">目标词汇量</div>
                    </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative pl-8 md:pl-12 group">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                 <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <span className="px-3 py-1 bg-purple-50 text-purple-700 text-sm font-bold rounded-lg">二级</span>
                    <h4 className="text-xl font-bold">理解与推断</h4>
                  </div>
                  <span className="text-sm text-[#86868b] mt-2 md:mt-0">适用阶段：3-5 年级</span>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2 text-[#86868b]">
                        <div className="flex items-center text-[#1d1d1f] font-medium mb-2">
                    ...
                    <div className="bg-purple-50/50 rounded-xl p-4 text-center">
                        <div className="text-3xl font-bold text-purple-600 mb-1">800-1000</div>
                        <div className="text-xs text-purple-800/60 font-medium uppercase tracking-wider">目标词汇量</div>
                    </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative pl-8 md:pl-12 group">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                 <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <span className="px-3 py-1 bg-orange-50 text-orange-700 text-sm font-bold rounded-lg">三级</span>
                    <h4 className="text-xl font-bold">分析与评价</h4>
                  </div>
                  <span className="text-sm text-[#86868b] mt-2 md:mt-0">适用阶段：5-9 年级</span>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2 text-[#86868b]">
                        <div className="flex items-center text-[#1d1d1f] font-medium mb-2">
                    ...
                    <div className="bg-orange-50/50 rounded-xl p-4 text-center">
                        <div className="text-3xl font-bold text-orange-600 mb-1">1600-2000</div>
                        <div className="text-xs text-orange-800/60 font-medium uppercase tracking-wider">目标词汇量</div>
                    </div>
                </div>
              </div>
            </div>
        ...
        <section>
          <div className="flex items-center space-x-2 mb-6">
            ...
            <h3 className="text-2xl font-bold">国际标准对标速查</h3>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left">
                <thead className="bg-[#f5f5f7] text-[#86868b]">
                  <tr>
                    <th className="px-6 py-4 font-medium">新课标级别</th>
                    <th className="px-6 py-4 font-medium">CEFR</th>
                    <th className="px-6 py-4 font-medium">蓝思值 (Lexile)</th>
                    <th className="px-6 py-4 font-medium">能力关键词</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 font-bold text-green-600">预备级</td>
                    <td className="px-6 py-4">&lt; A1</td>
                    <td className="px-6 py-4">BR - 170L</td>
                    <td className="px-6 py-4 text-[#86868b]">磨耳朵、语感</td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 font-bold text-blue-600">一级</td>
                    <td className="px-6 py-4">A1 / A1+</td>
                    <td className="px-6 py-4">150L - 430L</td>
                    <td className="px-6 py-4 text-[#86868b]">拼读、简单句</td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 font-bold text-purple-600">二级</td>
                    <td className="px-6 py-4">A2 / A2+</td>
                    <td className="px-6 py-4">400L - 600L</td>
                    <td className="px-6 py-4 text-[#86868b]">段落理解、独立阅读</td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 font-bold text-orange-600">三级</td>
                    <td className="px-6 py-4">B1 / B1+</td>
                    <td className="px-6 py-4">550L - 730L</td>
                    <td className="px-6 py-4 text-[#86868b]">语篇分析、观点表达</td>
                  </tr>
                </tbody>
              </table>
            </div>
